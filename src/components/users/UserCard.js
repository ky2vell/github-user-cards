    ...
    <>
      <Row>
        <Col className='d-flex'>
          <div className='py-4 font-bg flex-fill'>
            Hireable:{' '}
            {hireable ? (
          ...
          <Search setURL={props.setURL} searchUsers={props.searchUsers} />
        </Col>
      </Row>
      <Row>
        <Col>
          ...
          <Link to='/following' className='d-block text-right mt-4 font-bg'>
